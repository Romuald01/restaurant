...
<div class="row">
    <div class="col-md-12 tandc-background">

    </div>
</div>
<div class="container">
    <div class="col-md-12 text-center mt-5">
        <h1 class="tandc-heading">Terms and Condition</h1>
    </div>
    <div class="row">
        <div class="col-md-10 mx-auto">
            <div class="term-paragraph-div">
                <p class="term-paragraph">
                Please carefully read the terms and conditions (“Terms and Conditions”) below before placing any order from <a href="index.php" class="kilimanjaro-link">http://www.romuald-kilimanjaro-restaurants.com.</a> By placing an order for any of the food items from this Website, whereas it is by phone, through our mobile applications or by any other available channel,you agree to be bound by these Terms and Conditions.
                </p>

                <h5 class="section-number">Section 1:</h5>
                <p class="section-paragraph">
                We are Kilimanjaro restaurant, a brand of Sundry foods limited, operating with the URL <a href="index.php" class="kilimanjaro-link">http://www.romuald-kilimanjaro-restaurants.com</a> unless otherwise stated.
                </p>


                <h5 class="section-number">Section 2: Definitions</h5>
                <p class="section-paragraph">
                ...
                <p class="section-paragraph">
                     2.5. “Website” is a reference to our Website <a href="index.php" class="kilimanjaro-link"> http://www.romuald-kilimanjaro-restaurants.com.</a>
                </p>

                <h5 class="section-number">Section 3: Ordering</h5>
                <p class="section-paragraph">
                ...
                <h5 class="section-number">Section 4: Prices and Payment</h5>
                <p class="section-paragraph">
                ...
                <h5 class="section-number">Section 5: Delivery</h5>
                <p class="section-paragraph">
                ...
                <h5 class="section-number">Section 6: Cancellation</h5>
                <p class="section-paragraph">
                ...
                <h5 class="section-number">Section 7: Information</h5>
                <p class="section-paragraph">
                ...
                <h5 class="section-number">Section 8: Complaints.</h5>
                <p class="section-paragraph">
                    We take complaints very seriously and place customers at the core of our processes. We aim to respond to your complaints within 5 business days. Please submit any complaints to the following <a href="email: order@kilimanjaro-restaurants.com">
                    </a>
                </p>

                <h5 class="section-number">Section 9: Limitation of Liability.</h5>
                <p class="section-paragraph">
                ...
                <h5 class="section-number">Section 10: General</h5>
                <p class="section-paragraph">
